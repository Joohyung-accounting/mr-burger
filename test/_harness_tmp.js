...
/* ------------------------------------------------------------- DOM stubs */
var VIEW_W = +process.env.VW||412, VIEW_H = +process.env.VH||400;   // the kitchen canvas
...
module.exports={MB:MB,S:S,L:L,Core:Core,stage:stage,pump:pump,VIEW_W:VIEW_W,VIEW_H:VIEW_H};
